...
def video_pane() -> None:
    ...
    st.markdown(
        ...
        '<div class="aegis-subtle">Placeholder surface for the WebRTC feed.</div></div>',
    ...
    if frame is None:
        st.markdown(
            ...
            "No active frame available. Demo mode will populate this pane automatically."
            "</div></div>",
            unsafe_allow_html=True,
        )
        return
    ...
    st.markdown(
        (
            ...
            f"<span>Feed status: simulated</span>"
